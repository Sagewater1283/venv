...
for row in csv.reader(f):
    ...
    print('export PROJECT_NAME=' + row[1], file=rcfile)
    print('export PROJECT_DOMAIN_NAME=' + row[2], file=rcfile)
    print('export USERNAME=' + row[3], file=rcfile)
    print('export USER_DOMAIN_NAME=' + row[4], file=rcfile)
